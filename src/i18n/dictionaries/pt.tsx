...
projects: {
  ...
  items: {
    ...
    dp700: {
      ...
      location: "",
      description:
        "Certificação em design e implementação de soluções de análise de dados usando Microsoft Fabric, incluindo modelagem, segurança e otimização de desempenho.",
    }
  },
},contact: {
  title: "Contato",
